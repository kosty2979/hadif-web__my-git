...
export class EpgService {
    ...
    let daysForEpg = 2;// set days for epg timeline

		let startdate:string = ( moment().startOf('day').subtract(daysForEpg, 'days').format('YYYY-MM-DD') ).toString();
		let starttime:string = 	"00:00:01";
		
    let duration:string = 60*24*daysForEpg*2+"";
