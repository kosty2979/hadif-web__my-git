  ...
  $('.like-options').click(function(){
    ...
    $('.liker img').attr('src',"img/ic_feeling_heart_eyes.png");
  ...
  $('.trigger-edit').click(function() {
   $('<div class="each-playlist"><a href="#"><img src="img/thumb2.png" class="img-responsive"><p class="editable-text">في الصفحة التي</p></a></div>').insertBefore('.playlist-image');
  ...
  if (clicks) {
     $('.liker img').attr('src',"img/ic_cansel.png");
